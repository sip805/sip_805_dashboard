    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button onClick={onSignIn} className="text-sm text-gray-600 hover:text-gray-900 font-medium transition">Sign In</button>
            <button onClick={onSignUp} className="bg-purple-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-purple-700 transition">
              Get Started Free
            </button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-3">
            ...
            <button onClick={onSignIn} className="block text-sm text-gray-600 w-full text-left py-2">Sign In</button>
            <button onClick={onSignUp} className="w-full bg-purple-600 text-white font-semibold py-3 rounded-lg">Get Started Free</button>
          </div>
        )}
      </nav>
      ...
      <section className="pt-28 pb-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
            <button onClick={onSignUp} className="w-full sm:w-auto bg-purple-600 text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-purple-700 transition flex items-center justify-center gap-2">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <button onClick={onSignUp} className="mt-8 bg-white text-purple-700 font-bold px-10 py-4 rounded-xl hover:bg-purple-50 transition text-lg">
            Get Started Free
          </button>
        </div>
      </section>
